...
test('a binary STL keeps its count and its arithmetic together across the ABI', () => {
  ...
  assert.equal(tet[0], 'stl	284	tris	4	broken	0	solid	This file was generated by meshio v5.3.5.XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX', tet.join(' | '));
  ...
  assert.ok(many.includes('normals	zero	0	wrong	0	counted	16'), many.join(' | '));
