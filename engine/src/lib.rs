...
/// 27 sfnt font, 28 WOFF, 30 Apple icon directory, 31 Apple binary property list, 32 QOI, 33 JPEG 2000 PCA, 34 WOFF2, 35 NumPy array, 36 HDF5 superblock, 37 Avro container.
#[no_mangle]
