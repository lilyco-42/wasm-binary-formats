...
fn reads_the_xz_stream_a_real_xz_wrote() {
    ...
    assert_eq!(
        value("blockHeaderSize"),
        20,
        "(first byte + 1) * 4 for this block"
    );
